...
class PropertyOwnerRepository {
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const newOwner = new Owner_entity_1.Owner(propertyOwner);
                return newOwner;
            }
            catch (error) {
                console.log(error);
    ...
    findById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const propertyOwner = yield prismaClients_1.prisma.ownerProfile.findUnique({
                    include: { user: true },
                    where: { id },
                });
                if (!propertyOwner) {
                ...
                return new Owner_entity_1.Owner(propertyOwner);
            }
            catch (error) {
                console.log(error);
    ...
    getAll(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const owners = rawOwners.map((owner) => new Owner_entity_1.Owner(owner));
                return {
                    owners,
